...
export default function SubmitWorkForm({ taskId }: { taskId: string }) {
  ...
  return (
    <details className="mt-3 border-t border-hairline pt-3">
      <summary className="text-sm font-semibold cursor-pointer text-accent select-none">Submit work</summary>
      <form action={formAction} className="space-y-2 mt-3">
        ...
        <textarea
          ...
          className="field-area"
        />
        <div className="text-xs text-subtle text-center">— or —</div>
        <input
